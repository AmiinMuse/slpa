...
export const metadata = {
  title: "Leveraging Somaliland's Blue Economy | SLPA Op-Eds",
};
...
const BLOCKS = [
  ...
  {
    t: "p",
    s: "The Somaliland National Development Plan projected that by 2021 the tuna fish harvest will increase by 20% due to an increase in demand for fish stocks from urban areas. Despite the projected increase in demand, the industry has few challenges to address before any growth.",
  },
  {
    t: "p",
...
const PUBLISHED_IN = {
  ...
  links: [
    "https://sii1991.org/leveraging-somalilands-blue-economy/",
    "https://www.somalilandsun.com/somaliland-leveraging-the-countrys-least-exploited-blue-economy/",
    "https://somalilandchronicle.com/2021/04/06/leveraging-somalilands-blue-economy/",
  ],
};
...
export default function BlueEconomy() {
  return (
    <OpedArticle
      eyebrow="Q1 Quarterly Analytical Op-Ed by Deqa Aden"
      title="Leveraging Somaliland's Blue Economy — Fishery Industry"
      meta="by Deqa Aden"
      blocks={BLOCKS}
