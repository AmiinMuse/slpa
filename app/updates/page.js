    ...
    <>
      <section className="page-hero">
        <div className="wrap">
          ...
          <h1>Accomplishments, year by year.</h1>
          <p className="lede">
            From a Zoom launch in 2019 to one of the most successful Somaliland
            conferences in U.S. history &mdash; a record of what this community
            has built together.
          </p>
        </div>
      </section>
